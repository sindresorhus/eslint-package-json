...
test.snapshot({
	valid: [
		...
		`{"scripts": {"test": "echo ${shellParameterPrefix}A:-https://a.example}${shellParameterPrefix}B:-https://b.example}"}}`,
		`{"scripts": {"test": "curl ${shellParameterPrefix}PROTOCOL}://${shellParameterPrefix}HOST}/path"}}`,
		String.raw`{"scripts": {"test": "curl \"${shellParameterPrefix}PROTOCOL}://${shellParameterPrefix}HOST}/path\""}}`,
	...
	invalid: [
		...
		`{"scripts": {"test": "echo ${shellParameterPrefix}A:-relative} /tmp/file ${shellParameterPrefix}B:-relative}"}}`,
		...
		'{"scripts": {"test": "PATH=/usr/bin:https://example.com/bin tool"}}',
